      ...
      @section('content')
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <form action="{{ route('groupByProduct.store') }}" method="POST">
                    @csrf
                  <tbody class="divide-y divide-gray-200">
                    <tr>
                      ...
                      <td class="h-px w-px whitespace-nowrap">
                        <div class="px-6 py-2">
                            <input type="text" name="group_by_product_code" size="10" class="form-control" placeholder="" value="{{ old('group_by_product_code') }}">
                          </div>
                        </td>
                        <td class="h-px w-px whitespace-nowrap">
                          <div class="px-6 py-2">
