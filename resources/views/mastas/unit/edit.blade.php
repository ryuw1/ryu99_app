                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="divide-y divide-gray-200">
                    <tr>
                      ...
                      <td class="h-px w-px whitespace-nowrap">
                        <div class="px-6 py-2">
                          <input type="hidden" name="id" class="form-control" placeholder="" value=" {{ $Unit->id }} ">  
                          <input type="text" name="display_order" size="3" class="form-control" placeholder=""value="{{ $Unit->display_order}}">
                        </div>
                      </td>
                      <td class="h-px w-px whitespace-nowrap">
                        <div class="px-6 py-2">
                            <input type="text" name="name" size="30" class="form-control" placeholder="" value="{{ $Unit->name }}">
                        </div>
                      </td>
                      <div class="col-lg-12 mt-1 mr-1">
