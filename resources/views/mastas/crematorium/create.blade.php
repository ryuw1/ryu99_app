      ...
      @section('content')
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <form action="{{ route('crematorium.store') }}" method="POST">
                    @csrf
                  <tbody class="divide-y divide-gray-200">
                    <tr>
                      ...
                      <td class="h-px w-px whitespace-nowrap">
                          @csrf
                        <div class="px-6 py-2">
                          <input type="hidden" name="id" class="form-control" placeholder="" value="{{ old('id') }}">  
                      ...
                      <td class="h-px w-px whitespace-nowrap">
                        <div class="px-6 py-2">
                            <input type="text" name="other" size="20" class="form-control" placeholder="" value="{{ old('other') }}">
                        </div>
                      </td>
                      <div class="col-lg-12 mt-1 mr-1">
