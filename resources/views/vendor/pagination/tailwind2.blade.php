                        ...
                        @if (is_array($element))
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    ...
                                    {{-- ★現在のページの背景色を 変更★ --}}
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-gray-8
                                        00 bg-blue-500 border border-gray-300 cursor-default leading-5">{{ $page }}</span>
                                    </span>
                                @else
